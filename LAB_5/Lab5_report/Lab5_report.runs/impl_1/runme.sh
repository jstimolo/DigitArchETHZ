...
HD_PWD='C:/Users/jstimolo/Documents/ETHZ/FS21/Digital Design and Computer Architecture/LAB_5/Lab5_report/Lab5_report.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VLC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VLC.tcl -notrace
