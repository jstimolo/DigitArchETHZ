...
HD_PWD='C:/Users/jstimolo/Documents/ETHZ/FS21/Digital Design and Computer Architecture/LAB_5/Lab5_report/Lab5_report.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VLC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VLC.tcl
